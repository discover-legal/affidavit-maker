...
const TermsOfServicePage = () => {
  ...
  const pageTitle = 'Terms of Service | discover.legal';
  const pageDescription = 'Terms of service for discover.legal. Learn about the terms and conditions governing your use of our AI-powered legal document generation platform.';
