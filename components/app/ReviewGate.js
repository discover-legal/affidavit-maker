      ...
      >
        ...
        <div className="border-t p-4 sm:p-6 pt-4 flex-shrink-0 space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              Looks right — create my draft
            </button>
          </div>

          <p className="text-xs text-gray-500">
            These statements will end up in documents you sign under penalty of
            perjury. If anything is wrong, go back and correct it in the chat or
            on Your life story.
          </p>
        </div>
      </div>
