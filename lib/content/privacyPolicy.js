...
export const PRIVACY_POLICY_LAST_UPDATED = 'November 21, 2025';

export const PRIVACY_POLICY = `
# Privacy Policy

**Effective Date:** ${PRIVACY_POLICY_LAST_UPDATED}
...
- **Payment Information:** The service is currently free. If you choose to make a voluntary donation, or if paid features are ever introduced, billing information is collected through our payment processor (Stripe). We do not store your full credit card numbers.
...
- **To Process Payments:** Handle donations and any payment transactions securely (only if you choose to make one)
...
- **Stripe:** Payment processing (donations and any future paid features)
