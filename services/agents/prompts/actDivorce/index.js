...
KEY FACTS: FCFCOA (Division 2), Canberra registry. ONE ground: 12-month separation. Fee: AUD $1,125 (reduced $365 for concession card holders or financial hardship). The Application for Divorce seeks only the divorce order — property/parenting/maintenance orders need a separate Initiating Application.
${SHARED_RULES}`;
