...
const REVIEW = `Final review. Summarize and confirm. Filing fees ~NGN 10,000-30,000. Decree Nisi -> 3 months -> Decree Absolute (automatic, s.58; s.57 declaration where children under 16). A4 paper.\n${SHARED_RULES}`;
