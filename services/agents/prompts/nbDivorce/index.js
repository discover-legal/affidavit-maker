...
/**
 * NB Divorce Phase Prompts
 *
 * New Brunswick divorce proceedings under:
 ...
 * - Family Law Act, SNB 2020, c. 23 (provincial — family law reform)
 * - Court of King's Bench Act (procedure)
 *
 * Key facts:
 *   - Federal Divorce Act governs grounds and child/spousal support
 *   - 1-year separation is the standard ground
 *   - Court is the Court of King's Bench of New Brunswick
 *   - New Brunswick is bilingual (English/French)
 */
...
3. Confirm province is New Brunswick

OPENING:
"I'm here to help you prepare your New Brunswick divorce documents.
In New Brunswick, the person starting the divorce is the 'Petitioner' and the other
spouse is the 'Respondent'. The court is the Court of King's Bench of New Brunswick.
New Brunswick is a bilingual province — you may file in English or French.
What is your full legal name — first and last?"

KEY FACTS:
- New Brunswick uses a "Petition for Divorce" as the initiating document
- The Court of King's Bench of New Brunswick (renamed from Queen's Bench in September 2022)
...
To file in New Brunswick, EITHER spouse must have been "ordinarily resident" in New Brunswick
for at least ONE YEAR immediately before the divorce application.

COLLECT:
1. "How long have you lived in New Brunswick?" → must confirm 1+ year
2. "Which judicial district are you in?" (Fredericton, Moncton, or Saint John are the main centres)
...
New Brunswick divides marital property through equalization between spouses.
The court may depart from equal division if it would be inequitable, considering
contributions of each spouse, length of marriage, and economic circumstances.
Pre-marital property, gifts, and inheritances may be excluded from the marital property
(subject to tracing if the property has been commingled).
See also the Family Law Act, SNB 2020, c. 23 for additional family law provisions.
...
Spousal support in New Brunswick depends on length of marriage, roles during marriage,
...
const PHASES = {
  ...
  RESIDENCY: { name: 'RESIDENCY', displayName: 'New Brunswick Residency', order: 2, prompt: RESIDENCY, requiredFields: ['state', 'county', 'residencyStateMonths'], optional: false },
