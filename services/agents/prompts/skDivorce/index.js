...
const INTAKE = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
...
const RESIDENCY = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
...
const GROUNDS = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
...
const CHILDREN = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
...
const PROPERTY = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
...
const SUPPORT = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
...
const SERVICE = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
...
const REVIEW = `You are a legal document assistant helping someone apply for divorce in Saskatchewan, Canada.
Final review phase.
