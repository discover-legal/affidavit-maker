...
const INTAKE = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
...
const RESIDENCY = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
...
const GROUNDS = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
...
const CHILDREN = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
...
const PROPERTY = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
...
const SUPPORT = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
Spousal maintenance: ss.72-75. Discretionary.
COLLECT: 1. Seeking maintenance? 2. Amount/duration 3. Basis
REQUIRED FIELDS: spousal_support_confirmed
${SHARED_RULES}`;

const SERVICE = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
...
const REVIEW = `You are a document preparation assistant helping someone apply for divorce in Tasmania, Australia.
