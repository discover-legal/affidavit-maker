 ...
 * across all 7 supported states (TX, AZ, CA, FL, IL, NY, UT).
 *
...
const STATE_CONFIG = {
  ...
  FL: {
    name: 'Florida',
    court: (county) => `IN THE CIRCUIT COURT OF THE ${county ? county.toUpperCase() + ' JUDICIAL CIRCUIT' : '______ JUDICIAL CIRCUIT'}\nIN AND FOR ${county ? county.toUpperCase() + ' COUNTY' : '__________COUNTY'}, FLORIDA`,
    caseLabel: 'CASE NO.',
    petitionTitle: 'PETITION FOR DISSOLUTION OF MARRIAGE',
  ...
  _generateVerifiedComplaint(cfg, state, data) {
    ...
    const facts = {
      items: [
        {
          number: 1,
          content: `Plaintiff, ${petitioner}, is a resident of the State of New York and has been a resident of the State for at least two years immediately preceding the commencement of this action.`
        },
        {
          number: 2,
