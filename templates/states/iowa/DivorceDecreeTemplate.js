...
class IowaDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  ...
  generateChildCustodySection(divorceData) {
    ...
    if (custody.kind === 'joint') {
      items.push({
        content: `IT IS ORDERED that the parties shall share joint legal custody of the minor child(ren). ${resolvePrimaryResidenceName(divorceData) || divorceData.petitionerName || 'Petitioner'} shall have primary physical care.`,
        type: 'order'
      });
      ...
      items.push({
        content: `IT IS ORDERED that ${custodianName} shall have sole legal custody and physical care of the minor child(ren).`,
        type: 'order'
      });
    } else {
