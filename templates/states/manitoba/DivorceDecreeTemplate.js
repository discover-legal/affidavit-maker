// templates/states/manitoba/DivorceDecreeTemplate.js
// Manitoba divorce order template
 ...
 * Manitoba Divorce Order Template
 *
 * In Manitoba, the final divorce document is called a "Divorce Order" issued by the
 * Court of King's Bench of Manitoba. In uncontested cases, it may be granted on the
 * papers without a hearing (desk order procedure).
 *
 ...
 * "Court of King's Bench of Manitoba" in September 2022 upon accession of King Charles III.
 *
 * @class ManitobaDivorceDecreeTemplate
 * @extends BaseDivorceDecreeTemplate
 */
class ManitobaDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  constructor() {
    super();
  ...
  /**
   * Manitoba document header uses "PROVINCE OF MANITOBA" (not "STATE OF").
  ...
  /**
   * Manitoba venue uses location, not "COUNTY OF".
  ...
  /**
   * Manitoba case caption uses Petitioner/Respondent labels.
  ...
  /**
   * Manitoba property division under the Family Property Act, CCSM c. F25.
  ...
  generatePropertyDivisionSection(divorceData) {
    ...
    if (divorceData.hasProperty === false) {
      items.push({
        content: 'The Court finds there is no marital property to be divided under the Family Property Act, CCSM c. F25.',
        type: 'finding'
      });
    } else {
      items.push({
        content: 'The Court has considered the division of marital property pursuant to the Family Property Act, CCSM c. F25. Marital property is subject to equitable distribution having regard to the contributions and circumstances of each spouse.',
        type: 'finding'
      });
      ...
      if (!divorceData.petitionerProperty && !divorceData.respondentProperty) {
        items.push({
          content: 'IT IS ORDERED that each party retains the personal property currently in that party\'s possession, subject to equitable distribution under the Family Property Act, CCSM c. F25.',
          type: 'order'
        });
      }
    }
  ...
  /**
   * Manitoba child parenting order uses 2021 Divorce Act terminology:
  ...
  /**
   * Manitoba parenting time language — uses Divorce Act 2021 terminology.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Manitoba child support order pursuant to Divorce Act s.15.1 and the Federal
  ...
  /**
   * Manitoba spousal support order pursuant to Divorce Act s.15.2.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Manitoba final orders section — avoids US "decree" and "final judgment" language.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Manitoba divorce effective date: 31 days after the order is made (Divorce Act s.12(1)).
  ...
  /**
   * Manitoba uses "Certificate of Divorce" issued by the court registrar
...
module.exports = ManitobaDivorceDecreeTemplate;
