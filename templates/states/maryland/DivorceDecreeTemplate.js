...
class MarylandDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  ...
  generateChildCustodySection(divorceData) {
    ...
    if (custodyType === 'joint') {
      items.push({
        content: `IT IS ORDERED that the parties shall share joint legal custody of the minor child(ren). Primary physical custody is awarded to ${divorceData.primaryCustodian || divorceData.petitionerName || 'Plaintiff'}.`,
        type: 'order'
      });
    } else {
      items.push({
