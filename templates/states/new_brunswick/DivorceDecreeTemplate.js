// templates/states/new_brunswick/DivorceDecreeTemplate.js
// New Brunswick divorce order template
 ...
 * New Brunswick Divorce Order Template
 *
 * In New Brunswick, the Court of King's Bench of New Brunswick issues a "Divorce Order"
 * as the final order. In uncontested cases, it may be granted on the papers without a
 * hearing (desk order procedure).
 *
 ...
 * - Marital Property Act, RSNB 2012, c. 107 (property division — equalization)
 * - Family Services Act, SNB 1980, c. F-2.2 (maintenance and parenting arrangements)
 * - Rules of Court of New Brunswick (procedure)
 *
 * Note: The court title changed from "Court of Queen's Bench of New Brunswick" to
 * "Court of King's Bench of New Brunswick" in September 2022 upon accession of King Charles III.
 * New Brunswick is officially bilingual; proceedings may be conducted in English or French.
 *
 * @class NewBrunswickDivorceDecreeTemplate
 * @extends BaseDivorceDecreeTemplate
 */
class NewBrunswickDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  constructor() {
    super();
  ...
  /**
   * New Brunswick document header uses "PROVINCE OF NEW BRUNSWICK" (not "STATE OF").
   * NB is officially bilingual; French equivalent noted.
  ...
  /**
   * New Brunswick venue uses judicial district, not "COUNTY OF".
  ...
  /**
   * New Brunswick case caption uses Petitioner/Respondent labels.
   * NB is officially bilingual; proceedings may be in English or French.
  ...
  /**
   * New Brunswick property division under the Marital Property Act, RSNB 2012, c. 107.
  ...
  generatePropertyDivisionSection(divorceData) {
    ...
    if (divorceData.hasProperty === false) {
      items.push({
        content: 'The Court finds there is no marital property to be divided under the Marital Property Act, RSNB 2012, c. 107.',
        type: 'finding'
      });
    } else {
      items.push({
        content: 'The Court has considered the division of marital property pursuant to the Marital Property Act, RSNB 2012, c. 107. Marital property is subject to equitable distribution having regard to the contributions and circumstances of each spouse.',
        type: 'finding'
      });
      ...
      if (!divorceData.petitionerProperty && !divorceData.respondentProperty) {
        items.push({
          content: 'IT IS ORDERED that each party retains the personal property currently in that party\'s possession, subject to equitable distribution under the Marital Property Act, RSNB 2012, c. 107.',
          type: 'order'
        });
      }
    }

    return { title: 'DIVISION OF MARITAL PROPERTY', items, type: 'property' };
  }

  /**
   * New Brunswick child parenting order uses 2021 Divorce Act terminology:
  ...
  generateChildCustodySection(divorceData) {
    ...
    if (custody.kind === 'joint') {
      ...
      items.push({
        content: `IT IS ORDERED that the child(ren) shall primarily reside with ${resolvePrimaryResidenceName(divorceData) || divorceData.petitionerName || 'Petitioner'}, who shall have primary parenting time.`,
        type: 'order'
      });
  ...
  /**
   * New Brunswick parenting time language — uses Divorce Act 2021 terminology.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * New Brunswick child support order pursuant to Divorce Act s.15.1 and the Federal
  ...
  /**
   * New Brunswick spousal support order pursuant to Divorce Act s.15.2.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * New Brunswick final orders section — avoids US "decree" and "final judgment" language.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * New Brunswick divorce effective date: 31 days after the order is made (Divorce Act s.12(1)).
   * Parties may jointly apply to reduce the waiting period (s.12(2)).
   */
  ...
  /**
   * New Brunswick uses "Certificate of Divorce" issued by the court registrar
...
module.exports = NewBrunswickDivorceDecreeTemplate;
