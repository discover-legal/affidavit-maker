// templates/states/newfoundland/DivorceDecreeTemplate.js
// Newfoundland and Labrador divorce order template
 ...
 * Newfoundland and Labrador Divorce Order Template
 *
 * In Newfoundland and Labrador, the final divorce order is called a "Divorce Order"
 * (not "Decree Absolute"). It is issued by the Supreme Court of Newfoundland and Labrador
 * (Trial Division).
 * In uncontested cases, it is typically granted on the papers without a hearing.
 *
 ...
 */
class NewfoundlandDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  constructor() {
    super();
  ...
  /**
   * NL uses "Court File No." (not "CASE NO.").
  ...
  /**
   * Default court for NL — Supreme Court of Newfoundland and Labrador.
  ...
  /**
   * NL document header uses "PROVINCE OF NEWFOUNDLAND AND LABRADOR" (not "STATE OF").
  ...
  /**
   * NL venue uses location, not "COUNTY OF".
   * @param {string} county - Location
  ...
  /**
   * NL case caption uses Petitioner/Respondent labels.
  ...
  /**
   * NL property division under the Family Law Act, RSNL 1990, c. F-2.
  ...
  generatePropertyDivisionSection(divorceData) {
    ...
    if (divorceData.hasProperty === false) {
      items.push({
        content: 'The Court finds there is no matrimonial property to be divided under the Family Law Act, RSNL 1990, c. F-2.',
        type: 'finding'
      });
    } else {
      items.push({
        content: 'The Court has considered the division of matrimonial property pursuant to the Family Law Act, RSNL 1990, c. F-2. Matrimonial property is subject to equitable distribution having regard to the contributions and circumstances of each spouse.',
        type: 'finding'
      });
      ...
      if (!divorceData.petitionerProperty && !divorceData.respondentProperty) {
        items.push({
          content: 'IT IS ORDERED that each party retains the personal property currently in that party\'s possession, subject to equitable distribution under the Family Law Act, RSNL 1990, c. F-2.',
          type: 'order'
        });
      }
    }
  ...
  /**
   * NL child parenting order uses 2021 Divorce Act terminology:
  ...
  /**
   * NL parenting time language — uses Divorce Act 2021 terminology.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * NL child support order pursuant to Divorce Act s.15.1 and the Federal
  ...
  /**
   * NL spousal support order pursuant to Divorce Act s.15.2.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * NL final orders section — avoids US "decree" and "final judgment" language.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * NL divorce effective date: 31 days after order (Divorce Act s.12(1)).
  ...
  /**
   * NL uses "Certificate of Divorce" issued by the court registrar
  ...
  /**
   * NL judgment block — judge presiding at the Supreme Court.
   * @param {Object} divorceData - Divorce data
  ...
  generateJudgmentBlock(divorceData) {
    return {
      text: (
        `MADE at _____________________, Newfoundland and Labrador,\n` +
...
module.exports = NewfoundlandDivorceDecreeTemplate;
