...
class NorthDakotaDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  ...
  generateChildCustodySection(divorceData) {
    ...
    if (custody.kind === 'joint') {
      items.push({
        content: `IT IS ORDERED that the parties shall share equal decision-making responsibility for the minor child(ren). ${resolvePrimaryResidenceName(divorceData) || divorceData.petitionerName || 'Plaintiff'} shall have primary residential responsibility.`,
        type: 'order'
      });
      ...
      items.push({
        content: `IT IS ORDERED that ${custodianName} shall have sole primary residential responsibility and decision-making responsibility for the minor child(ren).`,
        type: 'order'
      });
    } else {
