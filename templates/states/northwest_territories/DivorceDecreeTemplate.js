// templates/states/northwest_territories/DivorceDecreeTemplate.js
// Northwest Territories divorce order template
 ...
 * Northwest Territories Divorce Order Template
 *
 * In the NWT, the final divorce document is called a "Divorce Order" issued by the
 * Supreme Court of the Northwest Territories. In uncontested cases, it may be granted
 ...
 * - Family Law Act, SNWT 1997, c. 18 (property division — equal division of family property)
 *
 * @class NorthwestTerritoriesDivorceDecreeTemplate
 * @extends BaseDivorceDecreeTemplate
 */
class NorthwestTerritoriesDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  constructor() {
    super();
  ...
  /**
   * NWT document header — territory designation.
  ...
  /**
   * NWT venue — no counties. Supreme Court sits in Yellowknife.
  ...
  /**
   * NWT property division under the Family Law Act, SNWT 1997, c. 18.
   * Family property is subject to equal division.
   * @param {Object} divorceData - Divorce data
  ...
  generatePropertyDivisionSection(divorceData) {
    ...
    if (divorceData.hasProperty === false) {
      items.push({
        content: 'The Court finds there is no family property to be divided under the Family Law Act, SNWT 1997, c. 18.',
        type: 'finding'
      });
    } else {
      items.push({
        content: 'The Court has considered the division of family property pursuant to the Family Law Act, SNWT 1997, c. 18. Family property is subject to equal division between the spouses.',
        type: 'finding'
      });
      ...
      if (!divorceData.petitionerProperty && !divorceData.respondentProperty) {
        items.push({
          content: 'IT IS ORDERED that each party retains the personal property currently in that party\'s possession, subject to equal division under the Family Law Act, SNWT 1997, c. 18.',
          type: 'order'
        });
      }
    }
  ...
  /**
   * NWT child parenting order uses 2021 Divorce Act terminology:
  ...
  /**
   * NWT parenting time language — uses Divorce Act 2021 terminology.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * NWT child support order pursuant to Divorce Act s.15.1 and the Federal
  ...
  /**
   * NWT spousal support order pursuant to Divorce Act s.15.2.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * NWT divorce effective date: 31 days after the order is made (Divorce Act s.12(1)).
   */
...
module.exports = NorthwestTerritoriesDivorceDecreeTemplate;
