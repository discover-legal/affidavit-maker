// templates/states/nova_scotia/DivorceDecreeTemplate.js
// Nova Scotia divorce order template
 ...
 * Nova Scotia Divorce Order Template
 *
 * In Nova Scotia, the Supreme Court (Family Division) issues a "Divorce Order" as the
 * final order. In uncontested cases, it may be granted on the papers without a hearing.
 *
 ...
 */
class NovaScotiaDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  constructor() {
    super();
  ...
  /**
   * Nova Scotia document header uses "PROVINCE OF NOVA SCOTIA" (not "STATE OF").
  ...
  /**
   * Nova Scotia venue uses location, not "COUNTY OF".
  ...
  /**
   * Nova Scotia case caption uses Petitioner/Respondent labels.
  ...
  /**
   * Nova Scotia property division under the Matrimonial Property Act, RSNS 1989, c. 275.
   * There is a presumption of equal division of matrimonial assets and debts (s.12).
  ...
  generatePropertyDivisionSection(divorceData) {
    ...
    if (divorceData.hasProperty === false) {
      items.push({
        content: 'The Court finds there is no matrimonial property to be divided under the Matrimonial Property Act, RSNS 1989, c. 275.',
        type: 'finding'
      });
    } else {
      items.push({
        content: 'The Court has considered the division of matrimonial assets and matrimonial debts pursuant to the Matrimonial Property Act, RSNS 1989, c. 275. There is a presumption of equal division of matrimonial assets and matrimonial debts unless doing so would be inequitable (s.12).',
        type: 'finding'
      });
      ...
      if (!divorceData.petitionerProperty && !divorceData.respondentProperty) {
        items.push({
          content: 'IT IS ORDERED that matrimonial assets and matrimonial debts shall be divided equally between the parties in accordance with the Matrimonial Property Act, RSNS 1989, c. 275, s.12.',
          type: 'order'
        });
      }
    }
  ...
  /**
   * Nova Scotia child parenting order uses 2021 Divorce Act terminology:
  ...
  /**
   * Nova Scotia parenting time language — uses Divorce Act 2021 terminology.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Nova Scotia child support order pursuant to Divorce Act s.15.1 and the Federal
  ...
  /**
   * Nova Scotia spousal support order pursuant to Divorce Act s.15.2.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Nova Scotia final orders section — avoids US "decree" and "final judgment" language.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Nova Scotia divorce effective date: 31 days after the order is made (Divorce Act s.12(1)).
  ...
  /**
   * Nova Scotia uses "Certificate of Divorce" issued by the court registrar
...
module.exports = NovaScotiaDivorceDecreeTemplate;
