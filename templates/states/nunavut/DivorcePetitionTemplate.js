 ...
 * Nunavut Divorce Application Template
 *
 * Nunavut uses the term "Application for Divorce" as the initiating document,
 * filed in the Nunavut Court of Justice.
 *
 * The Nunavut Court of Justice is unique in Canada — it is the only single-level
 * trial court in the country. Created under the Nunavut Act (SC 1993, c. 28), it
 ...
 */
class NunavutDivorcePetitionTemplate extends BaseDivorcePetitionTemplate {
  constructor() {
    super();
    ...
    // Nunavut residency: 1 year ordinary resident (Divorce Act s.3(1))
  ...
  /**
   * Nunavut venue — no counties. The Nunavut Court of Justice circuit sits
   * in various communities. Default is Iqaluit.
   */
  ...
  /**
   * Nunavut venue reason — no counties; Applicant or Respondent resides in Nunavut.
   */
  getVenueReason(divorceData) {
    return 'the Applicant or Respondent resides in Nunavut';
  }
  ...
  /**
   * Nunavut verification text.
   * Uses a sworn affidavit before a commissioner for oaths, notary public, or
...
module.exports = NunavutDivorcePetitionTemplate;
