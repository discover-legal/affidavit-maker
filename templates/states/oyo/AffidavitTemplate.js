// templates/states/oyo/AffidavitTemplate.js
'use strict';
...
class OyoAffidavitTemplate extends BaseAffidavitTemplate {
  ...
  performStateSpecificValidation(d) { const errors = [], warnings = []; if (!d.county && !d.city) errors.push('Judicial division required for Oyo State affidavits.'); return { errors, warnings }; }
...
module.exports = OyoAffidavitTemplate;
