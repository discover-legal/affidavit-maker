...
const Base = createIndiaAffidavitTemplate({ stateCode: 'IN_PB', stateName: 'Punjab', defaultCourt: 'Family Court, Ludhiana', defaultCity: 'Ludhiana', stampPaperValue: 'INR 15', metadataPath: '../states/punjab/metadata.json' });
