...
class RhodeIslandDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  ...
  generateChildCustodySection(divorceData) {
    ...
    if (custody.kind === 'joint') {
      items.push({
        content: `IT IS ORDERED that the parties shall share joint legal custody of the minor child(ren). ${resolvePrimaryResidenceName(divorceData) || divorceData.petitionerName || 'Plaintiff'} shall have primary physical placement.`,
        type: 'order'
      });
      ...
      items.push({
        content: `IT IS ORDERED that ${custodianName} shall have sole legal custody and physical placement of the minor child(ren).`,
        type: 'order'
      });
    } else {
