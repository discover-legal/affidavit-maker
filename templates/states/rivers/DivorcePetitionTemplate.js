...
class RiversDivorcePetitionTemplate extends BaseDivorcePetitionTemplate {
  ...
  getGroundsText(groundsForDivorce) {
    ...
    if (g.includes('restitution')) return 'The Respondent has failed to comply with a decree of restitution of conjugal rights made under the Act, within the meaning of section 15(2)(g) of the Matrimonial Causes Act, Cap M7 LFN 2004.';
