// templates/states/saskatchewan/DivorceDecreeTemplate.js
// Saskatchewan divorce order template
// Governing Law: Divorce Act (RSC 1985, c. 3); The Family Property Act, SS 1997, c. F-6.3
 ...
 * Saskatchewan Divorce Order Template
 *
 * In Saskatchewan, the Court of King's Bench for Saskatchewan issues a "Divorce Order"
 * as the final order. In uncontested cases, it may be granted by desk application
 * (without a hearing).
 *
 ...
 * - The Family Property Act, SS 1997, c. F-6.3 (property division — equal division)
 * - The Family Maintenance Act, 1997, SS 1997, c. F-6.2 (support)
 *
 * Note: The court title changed from "Court of Queen's Bench for Saskatchewan" to
 * "Court of King's Bench for Saskatchewan" in September 2022 upon accession of King Charles III.
 * Note the correct preposition: "for Saskatchewan" (not "of Saskatchewan").
 *
 * @class SaskatchewanDivorceDecreeTemplate
 * @extends BaseDivorceDecreeTemplate
 */
class SaskatchewanDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  constructor() {
    super();
  ...
  /**
   * Saskatchewan document header uses "PROVINCE OF SASKATCHEWAN" (not "STATE OF").
  ...
  /**
   * Saskatchewan venue uses judicial centre, not "COUNTY OF".
   * @param {string} county - Judicial centre
   * @returns {string} Venue text
   */
  generateVenue(county) {
    const centre = (county || '[JUDICIAL CENTRE]').toUpperCase();
    return `JUDICIAL CENTRE OF ${centre}`;
  }

  /**
   * Saskatchewan case caption uses Petitioner/Respondent labels.
  ...
  /**
   * Saskatchewan property division under The Family Property Act, SS 1997, c. F-6.3.
  ...
  generatePropertyDivisionSection(divorceData) {
    ...
    if (divorceData.hasProperty === false) {
      items.push({
        content: 'The Court finds there is no family property to be divided under The Family Property Act, SS 1997, c. F-6.3.',
        type: 'finding'
      });
    } else {
      items.push({
        content: 'The Court has considered the division of family property pursuant to The Family Property Act, SS 1997, c. F-6.3. Family property is subject to equitable distribution having regard to the contributions and circumstances of each spouse.',
        type: 'finding'
      });
      ...
      if (!divorceData.petitionerProperty && !divorceData.respondentProperty) {
        items.push({
          content: 'IT IS ORDERED that each party retains the personal property currently in that party\'s possession, subject to equitable distribution under The Family Property Act, SS 1997, c. F-6.3.',
          type: 'order'
        });
      }
    }
  ...
  /**
   * Saskatchewan child parenting order uses 2021 Divorce Act terminology:
  ...
  /**
   * Saskatchewan parenting time language — uses Divorce Act 2021 terminology.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Saskatchewan child support order pursuant to Divorce Act s.15.1 and the Federal
  ...
  /**
   * Saskatchewan spousal support order pursuant to Divorce Act s.15.2.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Saskatchewan final orders section — avoids US "decree" and "final judgment" language.
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Saskatchewan divorce effective date: 31 days after the order is made (Divorce Act s.12(1)).
  ...
  /**
   * Saskatchewan uses "Certificate of Divorce" issued by the court registrar
...
module.exports = SaskatchewanDivorceDecreeTemplate;
