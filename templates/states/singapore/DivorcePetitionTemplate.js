...
// Singapore Writ for Divorce template
 ...
 * Singapore Writ for Divorce Template
 *
 * Singapore uses the term "Writ for Divorce" to initiate divorce proceedings.
 * The Writ is filed together with a Statement of Claim and Statement of Particulars.
 *
 * Key Legal References:
 * - Women's Charter (Cap 353), Part X — governs divorce for non-Muslim marriages
 ...
 *   - s.95: Irretrievable breakdown — sole ground; proved by 6 facts (6th added 1 July 2024)
 ...
 * - Family Justice Rules 2024 — procedural rules
 *
 ...
 * - Filing fee: approx. SGD $50-$200 (legal aid available via Legal Aid Bureau)
 * - A4 paper size
...
class SingaporeDivorcePetitionTemplate extends BaseDivorcePetitionTemplate {
  constructor() {
    ...
    this.countryCode = 'SG';
    this.documentTitle = 'WRIT FOR DIVORCE';
    ...
    this.waitingPeriod = {
      days: 0,
      description: 'No mandatory waiting period after filing. However, a Writ for Divorce cannot be filed within 3 years of the date of marriage unless the court grants leave (Women\'s Charter, s.94).'
    };
   ...
   * Women's Charter proceedings use Writ for Divorce filed in Family Justice Courts.
   */
  ...
  getJurisdictionStatement(divorceData) {
    return 'Either the Plaintiff or the Defendant is domiciled in Singapore at the date of filing of this Writ, or has been habitually resident in Singapore for a period of at least 3 years immediately preceding the date of filing, as required by section 93 of the Women\'s Charter (Cap 353).';
  }
  ...
  generatePartiesSection(divorceData) {
    ...
    items.push({
      number: paragraphNum++,
      content: 'The marriage between the parties was not solemnized under Muslim law. This proceeding is brought under the Women\'s Charter (Cap 353).',
  ...
  generateReliefSection(divorceData) {
    ...
    const reliefItems = [
      'That the marriage between the Plaintiff and the Defendant be dissolved pursuant to section 95 of the Women\'s Charter (Cap 353);',
      'That the matrimonial assets of the parties be divided in a just and equitable manner pursuant to section 112 of the Women\'s Charter (Cap 353);'
    ];
    ...
    if (divorceData.hasMinorChildren === true || (divorceData.children && divorceData.children.length > 0)) {
      ...
      reliefItems.push('That the Defendant pay maintenance for the child(ren) of the marriage pursuant to section 69 of the Women\'s Charter (Cap 353);');
    }

    if (divorceData.spousalSupportRequested || divorceData.requestSpousalSupport) {
      reliefItems.push('That the Defendant pay maintenance to the Plaintiff pursuant to sections 113-114 of the Women\'s Charter (Cap 353);');
    }
  ...
  getVerificationText(divorceData) {
    ...
    return `I, ${name}, the Plaintiff, do solemnly swear (or affirm) that the facts stated in this Writ for Divorce and the accompanying Statement of Claim are true to the best of my knowledge, information, and belief.`;
  }
   ...
   *   (a) adultery — s.95(3)(a)
   *   (b) unreasonable behaviour — s.95(3)(b)
   *   (c) desertion for 2 years — s.95(3)(c)
   *   (d) 3-year separation with consent — s.95(3)(d)
   *   (e) 4-year separation without consent — s.95(3)(e)
   *   (f) mutual agreement — s.95(3)(f) (added 1 July 2024)
   */
  getGroundsStatement(groundsForDivorce) {
    const g = (groundsForDivorce || 'separation_consent').toLowerCase();
    if (g.includes('adultery')) {
      return 'The Defendant has committed adultery and the Plaintiff finds it intolerable to live with the Defendant, within the meaning of section 95(3)(a) of the Women\'s Charter (Cap 353).';
    }
    if (g.includes('unreasonable') || g.includes('behaviour') || g.includes('cruelty')) {
      return 'The Defendant has behaved in such a way that the Plaintiff cannot reasonably be expected to live with the Defendant, within the meaning of section 95(3)(b) of the Women\'s Charter (Cap 353).';
    }
    if (g.includes('desertion')) {
      return 'The Defendant has deserted the Plaintiff for a continuous period of at least 2 years immediately preceding the filing of this Writ, within the meaning of section 95(3)(c) of the Women\'s Charter (Cap 353).';
    }
    if (g.includes('4') || g.includes('four') || g.includes('no_consent') || g.includes('without_consent')) {
      return 'The parties have lived apart for a continuous period of at least 4 years immediately preceding the filing of this Writ, within the meaning of section 95(3)(e) of the Women\'s Charter (Cap 353).';
    }
    if (g.includes('mutual') || g.includes('agreement')) {
      return 'Both parties agree that the marriage has broken down irretrievably, within the meaning of section 95(3)(f) of the Women\'s Charter (Cap 353).';
    }
    // Default: 3-year separation with consent
    return 'The parties have lived apart for a continuous period of at least 3 years immediately preceding the filing of this Writ, and the Defendant consents to a judgment being granted, within the meaning of section 95(3)(d) of the Women\'s Charter (Cap 353).';
  }
