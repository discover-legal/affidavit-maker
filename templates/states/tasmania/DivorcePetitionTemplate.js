...
class TasmaniaDivorcePetitionTemplate extends BaseDivorcePetitionTemplate {
  constructor() {
    super();
    this.state = 'TAS'; this.stateName = 'Tasmania'; this.countryCode = 'AU'; this.documentTitle = 'APPLICATION FOR DIVORCE';
  ...
  generateReliefSection(divorceData) {
    ...
    if (divorceData.spousalSupportRequested || divorceData.requestSpousalSupport) reliefItems.push('A spousal maintenance order pursuant to sections 72-75;');
