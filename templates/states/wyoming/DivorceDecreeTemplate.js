// templates/states/wyoming/DivorceDecreeTemplate.js
// Wyoming Decree of Divorce template
 ...
 *
 * Wyoming-Specific Terms:
 * - "Decree of Divorce" (not Final Decree)
 * - "CIVIL NO." label
 * - Standard terminology: "Custody" / "Visitation" / "Alimony"
 * - Equitable distribution (NOT community property)
 * - District Court
 */
class WyomingDivorceDecreeTemplate extends BaseDivorceDecreeTemplate {
  constructor() {
    super();
  ...
  /**
   * Get effective date text for Wyoming
  ...
  /**
   * Generate Wyoming appearances section
  ...
  /**
   * Generate Wyoming jurisdiction section — 60-day residency, 20-day waiting period
   * @param {Object} divorceData - Divorce data
  ...
  generateJurisdictionSection(divorceData) {
    return {
      title: 'JURISDICTION',
      text: `The Court finds that it has jurisdiction over this proceeding and the parties. The Plaintiff has been a resident of Wyoming for at least sixty (60) days preceding the filing of the Complaint for Divorce. (Wyo. Stat. § 20-2-107) The parties were married on ${this.formatDate(divorceData.marriageDate) || '[DATE]'}${divorceData.marriageLocation ? ` in ${divorceData.marriageLocation}` : ''}. There exist irreconcilable differences between the parties. (Wyo. Stat. § 20-2-104) At least twenty (20) days have elapsed since the date the Complaint was filed. (Wyo. Stat. § 20-2-108)`,
      type: 'jurisdiction'
    };
  }

  /**
   * Generate Wyoming dissolution section
   * @param {Object} divorceData - Divorce data
  ...
  /**
   * Generate Wyoming property division — equitable distribution per Wyo. Stat. § 20-2-114
   * @param {Object} divorceData - Divorce data
  ...
  generatePropertyDivisionSection(divorceData) {
    ...
    items.push({
      content: 'The Court has considered the factors set forth in Wyo. Stat. § 20-2-114 and orders an equitable division of marital property as follows:',
      type: 'finding'
    });
  ...
  /**
   * Generate Wyoming child custody section — standard custody terminology
   * per Wyo. Stat. § 20-2-201
   * @param {Object} divorceData - Divorce data
  ...
  generateChildCustodySection(divorceData) {
    ...
    items.push({
      content: 'The Court finds that the following custody arrangement is in the best interests of the child(ren) pursuant to Wyo. Stat. § 20-2-201:',
      type: 'finding'
    });
    ...
    if (custodyType === 'joint') {
      items.push({
        content: `IT IS ORDERED that the parties shall share joint custody of the minor child(ren). The primary physical custody shall be with ${divorceData.primaryCustodian || divorceData.petitionerName || 'Plaintiff'}. (Wyo. Stat. § 20-2-201)`,
        type: 'order'
      });
    } else {
      items.push({
        content: `IT IS ORDERED that ${divorceData.primaryCustodian || divorceData.petitionerName || 'Plaintiff'} shall have sole custody of the minor child(ren). (Wyo. Stat. § 20-2-201)`,
        type: 'order'
      });
    }
  ...
  /**
   * Get Wyoming visitation language (standard terminology)
   * per Wyo. Stat. § 20-2-202
   * @param {Object} divorceData - Divorce data
   * @returns {string} Visitation language
   */
  getVisitationLanguage(divorceData) {
    return `IT IS ORDERED that the non-custodial parent shall have reasonable visitation with the minor child(ren) as agreed by the parties or, in the absence of agreement, as set forth in the Parenting Plan attached hereto and incorporated herein by reference. (Wyo. Stat. § 20-2-202)`;
  }

  /**
   * Generate Wyoming child support section per Wyo. Stat. § 20-2-304
   * @param {Object} divorceData - Divorce data
  ...
  generateChildSupportSection(divorceData) {
    ...
    if (divorceData.childSupportAmount) {
      items.push({
        content: `IT IS ORDERED that ${obligor} shall pay child support to ${obligee} in the amount of $${divorceData.childSupportAmount} per month, calculated in accordance with the Wyoming Child Support Guidelines, Wyo. Stat. § 20-2-304.`,
        type: 'order'
      });
    } else {
      items.push({
        content: `IT IS ORDERED that child support shall be paid in accordance with the Wyoming Child Support Guidelines, Wyo. Stat. § 20-2-304. The parties shall complete a Child Support Worksheet.`,
        type: 'order'
      });
    }
  ...
  /**
   * Generate Wyoming alimony section — "Alimony" per Wyo. Stat. § 20-2-114
   * @param {Object} divorceData - Divorce data
  ...
  generateSpousalSupportSection(divorceData) {
    ...
    if (divorceData.spousalSupportWaived) {
      ...
      items.push({
        content: `The Court, having considered the relevant factors under Wyo. Stat. § 20-2-114, orders alimony as follows:`,
        type: 'finding'
      });
  ...
  /**
   * Generate Wyoming judgment block
   * @param {Object} divorceData - Divorce data
...
${divorceData.county ? `${divorceData.county.toUpperCase()} COUNTY, STATE OF WYOMING` : '[COUNTY] COUNTY, STATE OF WYOMING'}`,
      type: 'judgment'
    };
  }
  ...
  performStateSpecificValidation(divorceData) {
    ...
    if (!divorceData.county) {
      errors.push('County is required for Wyoming Decree of Divorce');
    }

    if (!divorceData.caseNumber) {
      errors.push('Civil number is required for Wyoming Decree of Divorce');
    }

    warnings.push('Ensure Plaintiff has resided in Wyoming for at least 60 days before filing. (Wyo. Stat. § 20-2-107)');
    warnings.push('Ensure at least 20 days have elapsed from filing before entering the decree. (Wyo. Stat. § 20-2-108)');
    ...
    if (divorceData.hasMinorChildren === true || (divorceData.children && divorceData.children.length > 0)) {
      ...
      warnings.push('A completed Child Support Worksheet must be attached per Wyo. Stat. § 20-2-304.');
    }
...
module.exports = WyomingDivorceDecreeTemplate;
